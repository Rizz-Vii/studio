  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      ...
      <p className="text-xl text-muted-foreground mb-8">
        Master the art of finding and fixing broken links to boost your SEO performance.
      </p>
      ...
      <div className="prose prose-lg max-w-none">
        <section className="mb-8">
          ...
          <p>
            Broken links can seriously damage your SEO efforts and user experience. They:
          </p>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="border rounded-lg p-4">
              ...
              <p className="text-sm text-muted-foreground">
                Links pointing to pages within your own website that no longer exist.
              </p>
            </div>
            <div className="border rounded-lg p-4">
              <h3 className="font-semibold mb-2">External Broken Links</h3>
              <p className="text-sm text-muted-foreground">
                Links pointing to external websites that return 404 or other error codes.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold mb-4">Using RankPilot for Broken Link Analysis</h2>
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 mb-6">
            ...
            <ol className="list-decimal pl-6 space-y-2">
              <li>Navigate to the <Link href="/link-view" className="text-primary hover:underline">Link Analysis</Link> page</li>
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold mb-4">How to Fix Broken Links</h2>
          
          <h3 className="text-xl font-medium mb-3">For Internal Links:</h3>
          <ul className="list-disc pl-6 mb-4">
            <li><strong>Redirect:</strong> Set up 301 redirects to the most relevant existing page</li>
            <li><strong>Update:</strong> Change the link to point to the correct URL</li>
            <li><strong>Remove:</strong> Delete the link if it's no longer relevant</li>
          </ul>

          <h3 className="text-xl font-medium mb-3">For External Links:</h3>
          <ul className="list-disc pl-6">
            <li><strong>Find Alternative:</strong> Look for updated URLs or similar resources</li>
            <li><strong>Archive Check:</strong> Use Wayback Machine to find archived versions</li>
            <li><strong>Remove or Replace:</strong> Update with current, relevant resources</li>
          </ul>
        </section>
        ...
        <section className="mb-8">
          ...
          <div className="bg-gradient-to-r from-primary/10 to-blue-50 border border-primary/20 rounded-lg p-6">
            <p className="mb-4">
              Ready to find and fix broken links on your website? Use RankPilot's powerful 
              link analysis tool to get started.
            </p>
            <Link 
              href="/link-view" 
