...
const features = [
  {
    category: "SEO Tools",
    items: [
      { name: "Keyword Research & Tracking", starter: "50 keywords", pro: "500 keywords", enterprise: "Unlimited" },
      { name: "Competitor Analysis", starter: "5 competitors", pro: "25 competitors", enterprise: "Unlimited" },
      { name: "SEO Audit & Health Check", starter: "Basic", pro: "Advanced", enterprise: "Premium" },
      { name: "Backlink Analysis", starter: "50/month", pro: "500/month", enterprise: "Unlimited" },
      { name: "Content Brief Generator", starter: "Basic", pro: "AI-Powered", enterprise: "Advanced AI" },
    ]
  },
  {
    category: "Reporting & Analytics",
    items: [
      { name: "Report Frequency", starter: "Monthly", pro: "Weekly", enterprise: "Real-time" },
      { name: "Data Export", starter: "CSV", pro: "CSV, PDF", enterprise: "All formats" },
      { name: "Custom Dashboards", starter: "❌", pro: "✅", enterprise: "✅ Advanced" },
      { name: "White-label Reports", starter: "❌", pro: "Basic", enterprise: "Complete" },
    ]
  },
  {
    category: "Support & Integrations",
    items: [
      { name: "Support Channel", starter: "Email", pro: "Priority Email", enterprise: "24/7 Phone" },
      { name: "API Access", starter: "❌", pro: "Standard", enterprise: "Premium" },
      { name: "Team Collaboration", starter: "1 user", pro: "5 users", enterprise: "Unlimited" },
      ...
      <div className="max-w-7xl mx-auto px-4 py-16">
        ...
        >
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Choose the perfect plan for your SEO needs. No hidden fees, cancel anytime.
          </p>
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          {plans.map((plan, index) => (
            ...
            >
              ...
              <Card className={`h-full ${plan.badge ? 'border-primary shadow-lg scale-105' : ''} hover:shadow-xl transition-all duration-300`}>
                ...
                <CardContent className="space-y-6">
                  ...
                  <Button 
                    ...
                    size="lg"
                    onClick={() => handlePlanSelection(plan.id, isYearly ? plan.yearlyPrice : plan.price)}
                  >
                    <Link href={`/checkout?plan=${plan.id}&billing=${isYearly ? 'yearly' : 'monthly'}`}>
                      {user ? 'Upgrade to ' + plan.name : 'Start ' + plan.name + ' Plan'}
                    </Link>
                  </Button>
        ...
        >
          <Card>
            <CardHeader className="text-center">
              <CardTitle className="text-2xl mb-2">Detailed Feature Comparison</CardTitle>
              <CardDescription>
        ...
        >
          <Card className="bg-gradient-to-r from-primary/10 via-primary/5 to-primary/10 border-primary/20">
            <CardContent className="p-8">
              <h2 className="text-2xl font-bold mb-4">Ready to boost your SEO?</h2>
              <p className="text-muted-foreground mb-6">
                Join thousands of marketers who trust RankPilot for their SEO success.
              </p>
