      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription className="font-body">
            This analysis provides a holistic view of your content's quality.
            Use the suggestions to improve your scores and increase your chances
            of ranking.
          </CardDescription>
          <div className="flex flex-col sm:flex-row items-center gap-4 pt-2">
            <div className="w-full sm:w-1/2">
              ...
              <p className="text-sm text-muted-foreground font-body mt-1">
                A summary of your content's SEO health.
              </p>
            </div>
          ...
          >
            ...
            <AccordionItem value="keyword-density">
              <AccordionTrigger className="font-body hover:no-underline">
                <div className="flex w-full items-center justify-between pr-4">
                  <div className="flex items-center">
                    <Target className="mr-2 h-6 w-6 text-primary" /> Keyword
                    Optimization
                  </div>
                  <div className="flex items-center gap-4">
                    <span className="text-sm font-semibold">
    ...
    >
      ...
      >
        <motion.div layout className="lg:col-span-1">
          <ContentAnalyzerForm onSubmit={handleSubmit} isLoading={isLoading} />
        </motion.div>
