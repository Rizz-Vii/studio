    ...
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      ...
      <div className="prose prose-lg max-w-none">
        ...
        <section className="mb-8">
          ...
          <p>
            By accessing and using RankPilot, you accept and agree to be bound by the terms 
        ...
        <section className="mb-8">
          ...
          <p>
            RankPilot is an AI-powered SEO analysis platform that provides:
          </p>
        ...
        <section className="mb-8">
          ...
          <p>
            RankPilot and its original content, features, and functionality are owned by us 
        ...
        <section className="mb-8">
          ...
          <p>
            ...
            <a href="mailto:legal@rankpilot.com" className="text-primary hover:underline">
              legal@rankpilot.com
            </a>
          </p>
        </section>
