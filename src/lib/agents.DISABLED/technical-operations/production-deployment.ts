...
# ==============================================
NEXT_PUBLIC_APP_URL=https://rankpilot-h3jpc.web.app
NEXT_PUBLIC_BASE_URL=https://rankpilot-h3jpc.web.app
API_BASE_URL=https://rankpilot-h3jpc.web.app/api
NEXTAUTH_URL=https://rankpilot-h3jpc.web.app
...
if [ $? -eq 0 ]; then
    ...
    echo "🌍 Site available at: https://rankpilot-h3jpc.web.app"
else
...
- **API Health**: https://rankpilot-h3jpc.web.app/api/health
- **Monitoring**: https://rankpilot-h3jpc.web.app/monitoring
...
curl -f -s -o /dev/null https://rankpilot-h3jpc.web.app
if [ $? -eq 0 ]; then
...
curl -f -s https://rankpilot-h3jpc.web.app/api/health > /dev/null
if [ $? -eq 0 ]; then
    echo "✅ API is healthy"
else
...
curl -f -s https://rankpilot-h3jpc.web.app/api/neuroseo?userId=test > /dev/null
if [ $? -eq 0 ]; then
